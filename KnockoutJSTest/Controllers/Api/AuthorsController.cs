...
namespace KnockoutJSTest.Controllers.Api
{
    public class AuthorsController : ApiController
    {
        ...
        public ResultList<AuthorViewModel> Get([FromUri]QueryOptions queryOptions)
        {
            ...
            return new ResultList<AuthorViewModel>(AutoMapper.Mapper.Map<List<Author>, List<AuthorViewModel>>(authors), queryOptions);
        }
